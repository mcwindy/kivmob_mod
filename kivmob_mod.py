...
if platform == "android":
    try:
        ...
        RewardedAdLoadCallback4kivy = autoclass('org.example.admob.RewardedAdLoadCallback4kivy')
        # for making toast
        ...
        class OnUserEarnedRewardListener(PythonJavaClass):
            ...
            # processing when users get paid
            ...
            def onUserEarnedReward(self, reward_item):
                ...
                toast.show()
                # activate on_rewarded of RewardsHandler in main.py
                self._listener.on_rewarded(reward_item.getType(), reward_item.getAmount())
...
class AndroidBridge(AdMobBridge):
    ...
    def __init__(self, appID):
        ...
        InterstitialAdLoadCallback4kivy = autoclass('dev.twcn.myapp.InterstitialAdLoadCallback4kivy')
    ...
    def load_interstitial(self, unitID, options={}):
        ...
        InterstitialAd.load(appCompatActivity, unitID, adRequest, self.interstitialAdLoadCallback4kivy)
    ...
    def load_rewarded_ad(self, unitID, options={}):
        ...
        RewardedAdLoadCallback4kivy = autoclass('dev.twcn.myapp.RewardedAdLoadCallback4kivy')
        self.rewardedAdLoadCallback4kivy = RewardedAdLoadCallback4kivy()
        adRequest = self._get_builder(options).build()
        RewardedAd.load(appCompatActivity, unitID, adRequest, self.rewardedAdLoadCallback4kivy)
